    ...
    Ownable
{
    ...
    constructor(
        ...
        address _recurringPaymentsAddress
    ) ERC721("BaseWave", "BAW") Ownable(initialOwner) {
        recurringPaymentsContract = IRecurringPayments(
            _recurringPaymentsAddress
        );
    }
    ...
    function safeMint(address to) public onlyOwner {
        ...
        IRecurringPayments.Subscription
            memory subscription = recurringPaymentsContract.getSubscription(
                to,
                address(this)
            );

        require(
            subscription.exists && subscription.isActive,
    ...
    function getSubscriptionMetadata(
        uint256 tokenId
    ) public view returns (SubscriptionMetadata memory) {
